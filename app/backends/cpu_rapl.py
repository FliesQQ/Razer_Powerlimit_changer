"""Intel RAPL package power limit (PL1/PL2) via MSR."""
...
class CpuRaplBackend:
    ...
    def sample_package_power_w(self) -> Optional[float]:
        ...
        # Sanity clamp — package shouldn't report absurd spikes from wrap glitches.
    ...
    def apply(self, pl1_w: float, pl2_w: float, tau_s: float = 48.0) -> PowerLimits:
        ...
        def _write():
            # Write twice — laptop EC/XTU often races the first write.
        ...
        got = self.read()
        # If EC overwrote immediately, push once more.
